    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-10 shadow-2xl">
          ...
          <h1 className="text-2xl font-bold text-white text-center mb-1">AI Infra Efficiency</h1>
          <p className="text-slate-400 text-sm text-center mb-8">
            Monitor cost, cache, and routing for your LLM infrastructure
          </p>

          {/* Google Sign In */}
          <a
            href="/auth/google/login"
            className="flex items-center justify-center gap-3 w-full px-4 py-3 bg-white hover:bg-gray-50 active:bg-gray-100 text-gray-700 font-medium rounded-xl transition-all duration-150 shadow-sm hover:shadow-md"
          >
            {/* Google logo SVG */}
